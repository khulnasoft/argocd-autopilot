...
require (
	...
	github.com/argoproj/gitops-engine v0.7.1-0.20250129155113-a4b7cc110bf1 // indirect
	github.com/argoproj/notifications-engine v0.4.1-0.20240403133627-f48567108f01 // indirect
